...
if ! [[ -f "/data/data/com.termux/files/usr/lib/python3.11/site-packages/eyed3/main.py" ]]
then
	NoMetadata=-M
...
do
	...
	then
		if [[ $BASS == "true" ]]
		then
			python /data/data/com.termux/files/usr/lib/python3.11/site-packages/eyed3/main.py --remove-all "$TITLE - Bass.mp3" &> /dev/null
		fi
		if [[ $DRUMS == "true" ]]
		then
			python /data/data/com.termux/files/usr/lib/python3.11/site-packages/eyed3/main.py --remove-all "$TITLE - Drums.mp3" &> /dev/null
		fi
		if [[ $INSTRUMENTS == "true" ]]
		then
			python /data/data/com.termux/files/usr/lib/python3.11/site-packages/eyed3/main.py --remove-all "$TITLE - Instruments.mp3" &> /dev/null
		fi
		if [[ $MELODY == "true" ]]
		then
			python /data/data/com.termux/files/usr/lib/python3.11/site-packages/eyed3/main.py --remove-all "$TITLE - Melody.mp3" &> /dev/null
		fi
	...
	then
		python /data/data/com.termux/files/usr/lib/python3.11/site-packages/eyed3/main.py -t "$TITLE" -a "$ARTIST" "$TITLE.mp3" &> /dev/null
		if [[ $BASS == "true" ]]
		then
		python /data/data/com.termux/files/usr/lib/python3.11/site-packages/eyed3/main.py -t "$TITLE" -a "$ARTIST" --add-comment "Bass" "$TITLE - Bass.mp3" &> /dev/null
		fi
		if [[ $DRUMS == "true" ]]
		then
			python /data/data/com.termux/files/usr/lib/python3.11/site-packages/eyed3/main.py -t "$TITLE" -a "$ARTIST" --add-comment "Drums" "$TITLE - Drums.mp3" &> /dev/null
		fi
		if [[ $INSTRUMENTS == "true" ]]
		then
			python /data/data/com.termux/files/usr/lib/python3.11/site-packages/eyed3/main.py -t "$TITLE" -a "$ARTIST" --add-comment "Instruments" "$TITLE - Instruments.mp3" &> /dev/null
		fi
		if [[ $MELODY == "true" ]]
		then
			python /data/data/com.termux/files/usr/lib/python3.11/site-packages/eyed3/main.py -t "$TITLE" -a "$ARTIST" --add-comment "Melody" "$TITLE - Melody.mp3" &> /dev/null
		fi
	else
		python /data/data/com.termux/files/usr/lib/python3.11/site-packages/eyed3/main.py -t "$TITLE" -a "$ARTIST" --add-image "$TITLE.jpg":FRONT_COVER "$TITLE.mp3" &> /dev/null
		if [[ $BASS == "true" ]]
		then
			python /data/data/com.termux/files/usr/lib/python3.11/site-packages/eyed3/main.py -t "$TITLE" -a "$ARTIST" --add-image "$TITLE.jpg":FRONT_COVER --add-comment "Bass" "$TITLE - Bass.mp3" &> /dev/null
		fi
		if [[ $DRUMS == "true" ]]
		then
			python /data/data/com.termux/files/usr/lib/python3.11/site-packages/eyed3/main.py -t "$TITLE" -a "$ARTIST" --add-image "$TITLE.jpg":FRONT_COVER --add-comment "Drums" "$TITLE - Drums.mp3" &> /dev/null
		fi
		if [[ $INSTRUMENTS == "true" ]]
		then
			python /data/data/com.termux/files/usr/lib/python3.11/site-packages/eyed3/main.py -t "$TITLE" -a "$ARTIST" --add-image "$TITLE.jpg":FRONT_COVER --add-comment "Instruments" "$TITLE - Instruments.mp3" &> /dev/null
		fi
		if [[ $MELODY == "true" ]]
		then
			python /data/data/com.termux/files/usr/lib/python3.11/site-packages/eyed3/main.py -t "$TITLE" -a "$ARTIST" --add-image "$TITLE.jpg":FRONT_COVER --add-comment "Melody" "$TITLE - Melody.mp3" &> /dev/null
		fi
	fi
